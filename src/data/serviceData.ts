...
const serviceData = [
    ...
    {img:Lotion, title: 'Medical & Surgical Equipment Supplies', desc: 'We provide access to ethical, rare, orphan medications, health supplements, and other selected items'},
